            ...
            <div class="mt-4 space-y-4">
              ...
              <div class="flex justify-between items-center">
                ...
                <div class="flex items-center gap-2">
                  <input type="number" min="1" max="60" :value="settings.dns_cache_ttl" @change="
                    (e: Event) =>
                      handleSave(
                        'dns_cache_ttl',
              ...
              <div class="flex justify-between items-center">
                ...
                <input type="number" min="10" max="100" :value="settings.dns_batch_size" @change="
                  (e: Event) =>
                    handleSave(
                      'dns_batch_size',
                      parseInt((e.target as HTMLInputElement).value, 10),
              ...
              <div class="flex justify-between items-center">
                ...
                <div class="flex items-center gap-2">
                  <input type="number" min="5" max="300" :value="settings.dns_poll_interval" @change="
                    (e: Event) =>
                      handleSave(
                        'dns_poll_interval',
                        parseInt((e.target as HTMLInputElement).value, 10),
          ...
          <div>
            ...
            <div class="mt-4 space-y-4">
              ...
              <div class="flex justify-between items-center">
                ...
                <div class="flex items-center gap-2">
                  <input type="number" min="10" max="600" :value="settings.background_stop_delay" @change="
                    (e: Event) =>
                      handleSave(
